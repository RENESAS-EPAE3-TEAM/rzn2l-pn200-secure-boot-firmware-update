...
#define RSIP_CFG_WORD_SIZE_ENCRYPTED_KEY_OVERHEAD    (4U)
            #define RSIP_CFG_WORD_SIZE_WRAPPED_KEY_OVERHEAD      (8U)
            #define RSIP_CFG_WORD_SIZE_WRAPPED_PUBLIC_KEY_PREFIX (4U)
            ...
            #define RSIP_CFG_AES_128_ENABLE                      (0)
            #define RSIP_CFG_AES_256_ENABLE                      (0)
            #define RSIP_CFG_XTS_AES_128_ENABLE                  (0)
            #define RSIP_CFG_XTS_AES_256_ENABLE                  (0)

            #define RSIP_CFG_AES_ECB_CBC_CTR_ENABLE              (0)
            #define RSIP_CFG_AES_XTS_ENABLE                      (0)

            #define RSIP_CFG_AES_GCM_ENABLE                      (0)
            #define RSIP_CFG_AES_CCM_ENABLE                      (0)
            ...
            #define RSIP_CFG_ECC_SECP256K1_ENABLE                (0)
            #define RSIP_CFG_ECC_BRAINPOOLP256R1_ENABLE          (0)
            ...
            #define RSIP_CFG_HMAC_SHA224_ENABLE                  (0)
            #define RSIP_CFG_HMAC_SHA256_ENABLE                  (0)
            ...
            #define RSIP_CFG_KDF_SHA256_ENABLE                   (0)
